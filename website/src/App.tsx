...
const translations = {
  en: {
    ...
    hero: {
      ...
      description: "A terminal harness for local coding agents with a kernel runtime that turns small models into reliable coders — structured pipeline, CRP reasoning, approval-based edits.",
    ...
    features: {
      ...
      items: [
        { title: "Kernel mode", text: "A 5-stage pipeline (F5 to activate) that breaks tasks into bounded stages — Interpret, Locate, Hypothesize, Patch, Report — so small models produce reliable code edits." },
...
Landing page added. Review the diff, then push to deploy.`,
  ...
  pt: {
    ...
    hero: {
      ...
      description: "Um harness de terminal para agentes de código com um kernel runtime que transforma modelos pequenos em programadores confiáveis — pipeline estruturado, raciocínio CRP, edições com aprovação.",
      cta_install: "Instalar Cinto",
      cta_github: "Ver no GitHub",
    },
    metrics: [
      ["80%", "taxa de aprovação Python"],
    ...
    features: {
      ...
      items: [
        { title: "Modo Kernel", text: "Um pipeline de 5 estágios (F5 para ativar) que divide tarefas em etapas delimitadas — Interpretar, Localizar, Hipotetizar, Patch, Relatório — para que modelos pequenos produzam edições confiáveis." },
